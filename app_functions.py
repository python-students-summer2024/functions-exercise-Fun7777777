...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        question = "You rolled a {} and a {}... What is the sum of {} and {}?".format(die_1_value, die_2_value, die_1_value, die_2_value)
    else:
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    if question_type == "sum":
        ...
        return False
    return input_answer == correct_answer
...
def print_congratulations(question_type):
    ...
    if is_correct_answer is True:
        if question_type == "sum":
            ...
            print("Yes! Congratulations on the successful substraction!")
